...
ui <- fluidPage(
   titlePanel("eLatim-dependencias-v.0.3.funcs_feats_sems"),
      ...
      c(input$headword,input$arg1func,input$arg1feat),{
         if (input$arg1func=='Qualquer'){
            ...
            if (input$arg1feat=='Qualquer'){
               ...
               OutputDF <- BaseList[[input$headword]][ BaseList[[input$headword]][[paste0('ARG_',input$arg1func,'_feat')]]==input$arg1feat , ]
            }
         }
