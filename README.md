...
3. Copy **eLatim-vallex-main** folder to your **Documents** folder (NOTE: check for reduplication in folder structure, as Windows use to create two folders with the same name in zip extraction, one inside the other).
